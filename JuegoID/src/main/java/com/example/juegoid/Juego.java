...
public class Juego extends BorderPane {
    ...
    private void iniciarElementos() {
        ...
        botWall.widthProperty().bind(principal.widthProperty());

        topWall.setFill(Color.rgb(161, 1, 162));
        topWall.heightProperty().bind(principal.widthProperty().divide(40));
        topWall.widthProperty().bind(principal.widthProperty());

        player.setFill(Color.rgb(0, 0, 0));
        player.heightProperty().bind(leftWall.widthProperty().multiply(2));
        player.widthProperty().bind(leftWall.widthProperty().multiply(2));
        ...
        principal.setAlignment(botWall, Pos.BOTTOM_CENTER);
